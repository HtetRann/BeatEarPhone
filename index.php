...
<link rel="icon" href="headphone.png" type="image/icon type">
<!--=============== REMIX ICONS ===============-->
...
<header class="header" id="header">
	<nav class="nav container">
		<a href="#" class="nav__logo">
			<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Beats_Electronics_logo.svg/2048px-Beats_Electronics_logo.svg.png" alt="">
		</a>
...
<main class="main">
	...
	<section class="sponsor section">
		<div class="sponsor__container container grid">
			<img src="https://assets.codepen.io/7773162/sponsor1.png" alt="" class="sponsor__img">
			<img src="https://assets.codepen.io/7773162/sponsor2.png" alt="" class="sponsor__img">
			<img src="https://assets.codepen.io/7773162/sponsor3.png" alt="" class="sponsor__img">
			<img src="https://assets.codepen.io/7773162/sponsor4.png" alt="" class="sponsor__img">
		</div>
	</section>
	...
	<section class="specs section grid" id="specs">
		...
		<div class="specs__container container grid">
			...
			<div>
				<img src="https://assets.codepen.io/7773162/specs.png" alt="" class="specs__img">
			</div>
		</div>
	</section>
	...
	<section class="case section grid" id="case">
		...
		<div class="case__container container grid">
			<div>
				<img src="https://assets.codepen.io/7773162/case.png" alt="" class="case__img">
			</div>
	...
	<section class="discount section">
		<div class="discount__container container grid">
			...
			<img src="https://assets.codepen.io/7773162/discount.png" alt="" class="discount__img">
		</div>
	</section>
		...
		<div class="products__container container grid">
			<article class="products__card">
				<div class="products__content">
					<img src="https://assets.codepen.io/7773162/product1.png" alt="" class="products__img">
			...
			<article class="products__card">
				<div class="products__content">
					<img src="https://assets.codepen.io/7773162/product2.png" alt="" class="products__img">
			...
			<article class="products__card">
				<div class="products__content">
					<img src="https://assets.codepen.io/7773162/product3.png" alt="" class="products__img">
			...
			<article class="products__card">
				<div class="products__content">
					<img src="https://assets.codepen.io/7773162/product4.png" alt="" class="products__img">
			...
			<article class="products__card">
				<div class="products__content">
					<img src="https://assets.codepen.io/7773162/product5.png" alt="" class="products__img">
